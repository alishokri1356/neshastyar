...
`;
      ...
      for (const column of columns) {
        const defaultValue = column.Default !== null ? column.Default : 'NULL';
        const extra = column.Extra || '';
        markdown += `| ${column.Field} | ${column.Type} | ${column.Null} | ${column.Key} | ${defaultValue} | ${extra} |\n`;
      }
